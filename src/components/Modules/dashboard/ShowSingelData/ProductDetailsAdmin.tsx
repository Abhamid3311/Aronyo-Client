    ...
    <div className="max-w-7xl mx-auto px-4 py-8 bg-white">
      ...
      <div className="space-y-12">
        ...
        <div>
          ...
          <p className="text-gray-700 leading-relaxed">
            {product.detailsDesc || product.description}
          </p>
        </div>
            ...
            product.createdBy !== null ? (
              <>
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700">{product.createdBy.name}</p>
                </div>

                <div className="bg-gray-50 p-4 rounded-lg">
                  <span className="font-medium">Created by Email:</span>
                  <p className="text-gray-700">{product.createdBy.email}</p>
                </div>
              </>
            ) : (
              <div className="bg-gray-50 p-4 rounded-lg">
                <span className="font-medium">Created By:</span>
                <p className="text-gray-700">{product.createdBy}</p>
              </div>
            )}
          </div>
        </div>
