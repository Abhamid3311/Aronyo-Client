...
import { CodeNode } from "@lexical/code"; // Added CodeNode import
  ...
  const handleSubmit = async (data: Partial<IBlog>) => {
    try {
      const blogData = {
        ...data,
        tags,
        description: editorContent, // HTML from Lexical
      };
              ...
              render={({ field }) => (
                <FormItem>
                        ...
                        <LexicalErrorBoundary>
                          ...
                          <div className="relative min-h-[300px] max-h-[400px] overflow-y-auto">
                            <RichTextPlugin
                              contentEditable={
                                <ContentEditable
                                  className="editor-input px-4 py-4 min-h-[300px] outline-none resize-none text-sm leading-relaxed"
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Use the toolbar to format your content. Markdown shortcuts
                    are supported.
                  </p>
                  <FormMessage />
                </FormItem>
